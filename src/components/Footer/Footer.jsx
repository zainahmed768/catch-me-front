								...
								<Col lg={6}>
									<div className="footer-logo-wrapper text-lg-start text-center">
										...
										<p className="text-white pe-3">
											Catch-Me captures user’s mood with visible pie chart, and
											guides users to recognize thoughts and behavior patterns.
											Our MVP help users recognize their own ability to shift
											mood or change actions.
										</p>
									</div>
								...
								<Col lg="7">
									...
									<div className="footer-info-wrapper d-flex gap-3">
										<div className="phone-wrapper">
											<h6>CONTACT </h6>
											<Link to="tel:13605361565">+1 (360) 536-1565</Link>
										</div>
										<div className="phone-wrapper">
											<h6>Email </h6>
											<Link to="mailto:debs@catch-me.io">debs@catch-me.io</Link>
										</div>
									</div>
								</Col>
							</Row>
